...
export interface CallEvents {
    ...
    onGetAccuracyModifier? : (this: Battle, eventSource : any, trainer : TrainerBase, trainerTarget : TrainerBase, target : ActiveMonster | ActivePos | Scene | Side | Plot, source : ActivePos, sourceEffect : ActiveAction, relayVar: boolean, messageList: MessageSet, fromSource: boolean) => boolean; // Get a mulitplier to modify the final accuracy
