...
export interface CallEvents {
    ...
    onMonsterUseActionOnMainTarget? : (this : Battle, eventSource : any, source : FieldedMonster, target : FieldedMonster, sourceEffect : ActiveAction, relayVar : boolean, messageList : MessageSet, fromSource : boolean) => Promise<boolean> // If the action should be used on the Main target
    onMonsterUseActionOnSecondaryTarget? : (this : Battle, eventSource : any, source : FieldedMonster, target : FieldedMonster, sourceEffect : ActiveAction, relayVar : boolean, messageList : MessageSet, fromSource : boolean) => Promise<boolean> // If the action should be used on the Main target
    ...
    onOnEffectApply? : (this : Battle, eventSource : any, source : FieldedMonster, target : FieldedMonster, sourceEffect : ActiveAction, trackVal : IEffectData, messageList : MessageSet, fromSource : boolean) => Promise<void>; // When an effect is successfully applied to a target
    ...
    onGetStatModpt? : (this : Battle, eventSource : any, source : FieldedMonster | ActiveMonster, relayVar : number, messageList : MessageSet, fromSource : boolean) => Promise<number>; // Get the number of boosts for the PROTECTION stat
    onGetStatModsp? : (this : Battle, eventSource : any, source : FieldedMonster | ActiveMonster, relayVar : number, messageList : MessageSet, fromSource : boolean) => Promise<number>; // Get the number of boosts for the PROTECTION stat
