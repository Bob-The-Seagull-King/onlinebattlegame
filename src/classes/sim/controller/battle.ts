...
import { ActionAction, BaseBotOptions, BotBehaviourOptions, BotBehaviourWeight, BotOptions, ChosenAction, ItemAction, MessageSet, MoveAction, PlaceAction, SwapAction, TurnCharacter, TurnChoices, TurnSelect, TurnSelectReturn } from "../../../global_types";
...
class Battle {
     ...
     * @returns if relayVar is non null, it returns the value of the relayVar after each event has been run
     */
    public async runBehaviour(
        behaviourid: string,
        trainer: TrainerBot, 
        baseOptions? : BaseBotOptions,
        baseBotOptionSpecific? : BotBehaviourOptions,
        options? : BotOptions,
        ...
        for (const _event of Events) {
            ...
            if ((baseOptions !== undefined) && (baseOptions !== null)) { args[i] = baseOptions; i += 1; }
            if ((baseBotOptionSpecific !== undefined) && (baseBotOptionSpecific !== null)) { args[i] = baseBotOptionSpecific; i += 1; }
            ...
            if ((action !== undefined) && (action !== null)) { args[i] = action; i += 1; }
            if ((relay_variable !== undefined) && (relay_variable !== null)) { args[i] = relay_variable; i += 1; }
            if ((trackVal !== undefined) && (trackVal !== null)) { args[i] = trackVal; i += 1; }
